...
public class AuthController {
	...
	public ModelAndView registerUser(@Valid User user, BindingResult bindingResult, ModelMap modelMap, RedirectAttributes atts)
			throws IOException {
		ModelAndView modelAndView = new ModelAndView();
		atts.addAttribute("name", user.getName());
	...
	public ModelAndView forgotUserPassword(@RequestParam("email") String email, ModelAndView modelAndView) {
		...
		if (existingUser != null) {
			...
			return new ModelAndView("/authforgotPassword", ImmutableMap.of("message", "Email is not valid!"));
		}
	}
